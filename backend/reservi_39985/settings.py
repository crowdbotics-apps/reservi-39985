"""
Django settings for reservi_39985 project.
...
ROOT_URLCONF = 'reservi_39985.urls'
...
WSGI_APPLICATION = 'reservi_39985.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "reservi_39985 API",
    "DESCRIPTION": "API documentation for reservi_39985 App",
    "VERSION": "v1",
}
